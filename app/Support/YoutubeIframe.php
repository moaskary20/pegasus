...
/**
 * معاملات مشغّل YouTube المضمّن بدون شريط التحكم الافتراضي (controls=0)، مع تقليل العلامة والفيديوهات ذات الصلة قدر ما تسمح به واجهة البرمجة.
 */
final class YoutubeIframe
{
    ...
    public static function embedSrcFromVideoId(?string $videoId, bool $autoplay = true): ?string
    {
        ...
        $params = [
            // 0 = إخفاء شريط تحكم اليوتيوب (شريط التقدّم، الصوت، الإعدادات، إلخ) داخل المشغّل.
            'controls' => 0,
            'fs' => 0,
            'modestbranding' => 1,
            'rel' => 0,
