...
class VoucherResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'القسائم والخصومات';

    protected static ?string $modelLabel = 'قسيمة';

    protected static ?string $pluralModelLabel = 'القسائم والخصومات';
