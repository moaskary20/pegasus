...
class MyAssignments extends Page
{
    ...
    protected static ?string $navigationLabel = 'واجباتي';
    
    protected static ?string $title = 'واجباتي';
    ...
    {
        $enrolledCourseIds = Enrollment::where('user_id', auth()->id())->pluck('course_id');
        
        $pending = Assignment::whereIn('course_id', $enrolledCourseIds)
            ->where('is_published', true)
